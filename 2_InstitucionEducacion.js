...
function ProcesamientoDatosIngresados() {
  ...
  tpdcarrera == "vespertina" && ntobtenida >= n1 && ntobtenida <= n3
    ? console.warn(
        "\n",
        "Apellido: " + apellido,
        "\n",
  ...
  tpdcarrera == "vespertina" && ntobtenida >= n2 && ntobtenida < n1
    ? console.log(
        "\n",
        "Apellido: " + apellido,
        "\n",
  ...
  tpdcarrera == "diurna" && ntobtenida >= n1 && ntobtenida <= n3
    ? console.error(
        "\n",
        "Apellido: " + apellido,
        "\n",
  ...
  tpdcarrera == "diurna" && ntobtenida >= n2 && ntobtenida < n1
    ? console.info(
        "\n",
        "Apellido: " + apellido,
        "\n",
  ...
  tpdcarrera == "vespertina" && ntobtenida >= n4 && ntobtenida < n2
    ? console.warn(
        "\n",
        "Apellido: " + apellido,
        "\n",
  ...
  tpdcarrera == "diurna" && ntobtenida >= n4 && ntobtenida < n2
    ? console.log(
        "\n",
        "Apellido: " + apellido,
        "\n",
  ...
  tpdcarrera == "vespertina" && ntobtenida == ""
    ? console.info(
        "\n",
        "Apellido: " + apellido,
        "\n",
  ...
  tpdcarrera == "vespertina" && ntobtenida > n3
    ? console.log(
        "\n",
        "Apellido: " + apellido,
        "\n",
  ...
  tpdcarrera == "diurna" && ntobtenida > n3
    ? console.error(
        "\n",
        "Apellido: " + apellido,
        "\n",
