...
function VerTipoTriangulo() {
  ...
  if (AngulosTodos === 0) {
    console.error(
      "En un triángulo los 3 ángulos son diferentes, revisar los datos ingresados."
    );
