...
function recalculando() {
    ...
    if (isNaN(montoapagar)) {
        ...
        labelresultado.innerHTML = `¡Faltan Datos: Monto de Dinero!`
            ...
            console.log(`La cuenta final a abonar por el cliente es: $${cuentafinal}. No obtiene descuento porque la bolita es de color blanco.`);
            ...
            console.log(`Descuento obtenido del 10%: $${cuentafinal}. La cuenta final a abonar por el cliente es: $${cuentafinaltotal}.`);
            ...
            cuentafinaltotal = montoapagar - cuentafinal;
            console.log(`Descuento obtenido del 25%: $${cuentafinal}. La cuenta final a abonar por el cliente es: $${cuentafinaltotal}.`);
            ...
            cuentafinaltotal = montoapagar - cuentafinal;
            console.log(`Descuento obtenido del 50%: $${cuentafinal}. La cuenta final a abonar por el cliente es: $${cuentafinaltotal}.`);
            ...
            cuentafinal = 0
            console.log(`La cuenta final a abonar por el cliente es: $${cuentafinal}. Lleva gratis los productos elegidos.`);
            labelconsola.innerHTML = `La cuenta final a abonar por el cliente es: $${cuentafinal}. Lleva gratis los productos elegidos.`;
            labelresultado.innerHTML = `$${cuentafinal}`
            }

            else {
                console.error(`Contactar al administrador del proyecto porque hay fallas en el sistema.`)
            }
